...
%% Define symbolic and related numeric values

% Grab I, D, K numerics
Ival = [I(1,1), I(2,2), I(3,2), I(3,3), I(4,1), I(4,4), I(5,2), I(5,5), I(6,2), I(6,3), I(6,6), I(7,1), I(7,4), I(7,7)];
Dval = [D(1,1), D(2,1), D(2,2), D(3,1), D(3,2), D(3,3), D(4,1), D(4,4), D(5,5), D(6,5), D(6,6), D(7,5), D(7,6), D(7,7)];
Kval = [K(1,1), K(2,1), K(2,2), K(3,1), K(3,2), K(3,3), K(4,1), K(4,4), K(5,5), K(6,5), K(6,6), K(7,5), K(7,6), K(7,7)];

syms I11 I22 I32 I33 I41 I44 I52 I55 I62 I63 I66 I71 I74 I77 real
Ivar = [I11, I22, I32, I33, I41, I44, I52, I55, I62, I63, I66, I71, I74, I77];

syms K11 K21 K22 K31 K32 K33 K41 K44 K55 K65 K66 K75 K76 K77 real
Kvar = [K11, K21, K22, K31, K32, K33, K41, K44, K55, K65, K66, K75, K76, K77];

syms D11 D21 D22 D31 D32 D33 D41 D44 D55 D65 D66 D75 D76 D77 real
Dvar = [D11, D21, D22, D31, D32, D33, D41, D44, D55, D65, D66, D75, D76, D77];  

w2 = sym('w2','real');

w3 = frequency_band*2.0*pi;

% Define values to replace symbolic variables
myvals = [Ival Dval Kval];
myvars = [Ivar Dvar Kvar];

% G3inv
% g3 = subs(invG3, myvars, myvals);
% g3inv = subs(g3, w2, 5*2*pi);
